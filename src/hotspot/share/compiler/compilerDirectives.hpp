...
NOT_PRODUCT(cflags(PhasePrintLevel, int, PrintPhaseLevel, PhasePrintLevel)) \
NOT_PRODUCT(cflags(IGVPrintLevel,   int, PrintIdealGraphLevel, IGVPrintLevel)) \
